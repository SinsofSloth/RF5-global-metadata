public static class MessagePackCode // TypeDefIndex: 5130
{
	// Fields
	...
	private static readonly MessagePackType[] TypeLookupTable; // 0x0
	private static readonly string[] FormatNameTable; // 0x8

	// Methods

	// RVA: 0x168BB70 Offset: 0x168BC71 VA: 0x168BB70
	private static void .cctor() { }

	// RVA: 0x168CFC0 Offset: 0x168D0C1 VA: 0x168CFC0
	public static MessagePackType ToMessagePackType(byte code) { }

	// RVA: 0x168D060 Offset: 0x168D161 VA: 0x168D060
	public static string ToFormatName(byte code) { }

	// RVA: 0x168D100 Offset: 0x168D201 VA: 0x168D100
