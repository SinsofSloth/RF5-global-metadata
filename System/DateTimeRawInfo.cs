internal struct DateTimeRawInfo // TypeDefIndex: 245
{
	// Fields
	private int* num; // 0x0
	...
	// RVA: 0x135C0 Offset: 0x136C1 VA: 0x135C0
	internal void Init(int* numberBuffer) { }

	// RVA: 0x135E0 Offset: 0x136E1 VA: 0x135E0
	internal void AddNumber(int value) { }

	// RVA: 0x13600 Offset: 0x13701 VA: 0x13600
