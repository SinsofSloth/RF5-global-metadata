public static class PlayerParamDefine // TypeDefIndex: 10819
{
	// Fields
	...
	public const float ContinueDay_Tier = 0.5;
	public const float ContinueDay_Sick = 0.25;
	...
	public static int FireExp_SuccessSynthesis; // 0x0
	public static int FailureExpMax_Synthesis; // 0x4
	public static int ExpMin_Synthesis; // 0x8
	public const int NoDropCap_Dummy = 9000;
	public static ItemID[] IgnoreCapItems; // 0x10
	public static ItemID[] IgnoreCapSkillMagic; // 0x18
	public static int CategoryLotteryCount; // 0x20
	public static int TreasureOverCapLimit; // 0x24
	public static int TresureOver_AddLottery_Base; // 0x28
	public static int TresureOver_AddLottery; // 0x2C
	...
	// RVA: 0x1CE8B40 Offset: 0x1CE8C41 VA: 0x1CE8B40
