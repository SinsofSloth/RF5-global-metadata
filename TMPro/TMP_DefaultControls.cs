public static class TMP_DefaultControls // TypeDefIndex: 5769
{
	// Fields
	...
	// RVA: 0x1550160 Offset: 0x1550261 VA: 0x1550160
	private static GameObject CreateUIElementRoot(string name, Vector2 size) { }

	// RVA: 0x1550210 Offset: 0x1550311 VA: 0x1550210
	private static GameObject CreateUIObject(string name, GameObject parent) { }

	// RVA: 0x15503E0 Offset: 0x15504E1 VA: 0x15503E0
	private static void SetDefaultTextValues(TMP_Text lbl) { }

	// RVA: 0x1550480 Offset: 0x1550581 VA: 0x1550480
	private static void SetDefaultColorTransitionValues(Selectable slider) { }

	// RVA: 0x15502D0 Offset: 0x15503D1 VA: 0x15502D0
	private static void SetParentAndAlign(GameObject child, GameObject parent) { }

	// RVA: 0x1550500 Offset: 0x1550601 VA: 0x1550500
	private static void SetLayerRecursively(GameObject go, int layer) { }

	// RVA: 0x1550600 Offset: 0x1550701 VA: 0x1550600
	public static GameObject CreateScrollbar(TMP_DefaultControls.Resources resources) { }

	// RVA: 0x1550900 Offset: 0x1550A01 VA: 0x1550900
	public static GameObject CreateButton(TMP_DefaultControls.Resources resources) { }

	// RVA: 0x1550B90 Offset: 0x1550C91 VA: 0x1550B90
	public static GameObject CreateText(TMP_DefaultControls.Resources resources) { }

	// RVA: 0x1550C30 Offset: 0x1550D31 VA: 0x1550C30
	public static GameObject CreateInputField(TMP_DefaultControls.Resources resources) { }

	// RVA: 0x15511C0 Offset: 0x15512C1 VA: 0x15511C0
	public static GameObject CreateDropdown(TMP_DefaultControls.Resources resources) { }

	// RVA: 0x1552360 Offset: 0x1552461 VA: 0x1552360
