internal sealed class X501 // TypeDefIndex: 53
{
	...
	// RVA: 0x1904230 Offset: 0x1904331 VA: 0x1904230
	public static string ToString(ASN1 seq) { }

	// RVA: 0x1904B30 Offset: 0x1904C31 VA: 0x1904B30
	public static string ToString(ASN1 seq, bool reversed, string separator, bool quotes) { }

	// RVA: 0x19043E0 Offset: 0x19044E1 VA: 0x19043E0
	private static void AppendEntry(StringBuilder sb, ASN1 entry, bool quotes) { }

	// RVA: 0x1904DD0 Offset: 0x1904ED1 VA: 0x1904DD0
	private static void .cctor() { }
}

public sealed class X501 // TypeDefIndex: 1557
{
	// Fields
	private static byte[] countryName; // 0x0
	private static byte[] organizationName; // 0x8
	...
	// RVA: 0x1A7BF00 Offset: 0x1A7C001 VA: 0x1A7BF00
	public static string ToString(ASN1 seq) { }

	// RVA: 0x1A7CBD0 Offset: 0x1A7CCD1 VA: 0x1A7CBD0
	public static string ToString(ASN1 seq, bool reversed, string separator, bool quotes) { }

	// RVA: 0x1A7C0D0 Offset: 0x1A7C1D1 VA: 0x1A7C0D0
	private static void AppendEntry(StringBuilder sb, ASN1 entry, bool quotes) { }

	// RVA: 0x1A7CE80 Offset: 0x1A7CF81 VA: 0x1A7CE80
	private static void .cctor() { }
}
